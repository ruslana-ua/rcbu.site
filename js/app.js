 ...
 */
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".products__slider") && window.matchMedia("(max-width: 767.98px)").matches) new swiper_core_Swiper(".products__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
  ...
  */
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            const searchOpenButton = document.querySelector(".search-header__button--open");
            ...
            document.addEventListener("click", (function(event) {
                if (!searchHeader.contains(event.target)) searchForm.classList.remove("show");
            }));
        }));
        document.addEventListener("DOMContentLoaded", (() => {
            const inputFile = document.querySelectorAll(".form__input--file");
            inputFile.forEach((function(el) {
                let textSelector = document.querySelector(".form__text");
                let fileList;
